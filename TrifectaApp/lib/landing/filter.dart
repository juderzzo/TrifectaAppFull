              ...
              Row(children: [
                ...
                Container(
                    ...
                    child: FlatButton(
                      ...
                      onPressed: () =>
                          setState(() => pressBeginner = !pressBeginner),
                    )),
                ...
                Container(
                    ...
                    child: FlatButton(
                      ...
                      color:
                          pressIntermediate ? Colors.white : Colors.grey[300],
                      //color: pressAll ? Colors.grey[300] : Colors.white,
                      onPressed: () => setState(
                ...
                Container(
                    ...
                    child: FlatButton(
                      ...
                      //color: pressAll ? Colors.grey[300] : Colors.white,
                      onPressed: () =>
                          setState(() => pressExpert = !pressExpert),
                    )),
                Spacer()
              ]),
              ...
              Row(children: [
                ...
                Container(
                    ...
                    child: FlatButton(
                      ...
                      //color: pressAll ? Colors.grey[300] : Colors.white,
                      onPressed: () =>
                          setState(() => pressClasses = !pressClasses),
                    )),
                Spacer(),
              ]),
              ...
              Row(children: [
                ...
                Container(
                    ...
                    child: FlatButton(
                      ...
                      //color: pressAll ? Colors.grey[300] : Colors.white,
                      onPressed: () =>
                          setState(() => pressBoxing = !pressBoxing),
                    )),
                ...
                Container(
                    ...
                    child: FlatButton(
                      ...
                      //color: pressAll ? Colors.grey[300] : Colors.white,
                      onPressed: () =>
                          setState(() => pressRunning = !pressRunning),
                    )),
                Spacer()
              ]),
